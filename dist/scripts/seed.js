...
// Script di inizializzazione dati per ambiente di sviluppo/demo
async function main() {
    ...
    // Capacità per domani, fasce 8-20 (maggiore a mezzogiorno)
    const tomorrow = dayjs().add(1, 'day').format('YYYY-MM-DD');
    for (let h = 8; h <= 20; h++) {
        const max = h >= 10 && h <= 16 ? 50 : 30; // più capacità a metà giornata
